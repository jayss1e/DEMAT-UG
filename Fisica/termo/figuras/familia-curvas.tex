...
\begin{tikzpicture}
  ...
  \foreach \c in {0,0.9,1.8} {
    \draw[line width=1pt,domain=0.2:4.4,samples=50,smooth,variable=\x] plot ({\x},{0.15*\x*\x+0.6+\c});
  }
  \draw[dashed,gray,line width=0.5pt] (2.4,0) -- (2.4,3.9);
  \foreach \c in {0,0.9,1.8} {
    \pgfmathsetmacro{\yy}{0.15*2.4*2.4+0.6+\c}
    \draw[UGblue,line width=0.8pt] (1.6,{\yy-0.36*2.4*0.8}) -- (3.2,{\yy+0.36*2.4*0.8});
  }
\end{tikzpicture}
\end{document}
