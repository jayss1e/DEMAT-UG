...
\addplot3[patch,patch type=rectangle,shader=flat,fill=UGblue!35,fill opacity=0.22,draw=UGblue!70,line width=0.4pt] coordinates {(-1.15,0.7,0) (1.15,0.7,0) (1.15,0.7,1.5) (-1.15,0.7,1.5)};
\draw[thick,UGblue] plot[domain=-1:1,samples=40,variable=\t] (axis cs:{\t},{0.7},{0.4+0.95*sqrt(0.7)-0.4*\t*\t});
\node[circle,fill,inner sep=1.5pt,label={[font=\small]above right:$A$}] at (axis cs:0.0000,0.7000,1.1948) {};
\end{axis}
\end{tikzpicture}
\end{document}
