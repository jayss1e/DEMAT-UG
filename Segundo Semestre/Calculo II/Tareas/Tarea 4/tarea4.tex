...
\begin{document}
    ...
    \begin{proof}
      Para (c), supongamos que existe un punto $p$ tal que la integral impropia en $(a,b)$ esta bien definida. Tomemos un punto $P^{\prime}$ y supongamos que $p\lt p^{\prime}$ el otro
      caso es analogo. Notemos que para $a\lt x\lt p$ se tiene
    \end{proof}
